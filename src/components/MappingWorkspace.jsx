...
export default function MappingWorkspace({ onBack }) {
  ...
  const [questions, setQuestions] = useState([
    {
      ...
      total: 2,
      status: 'full',
      feedback: 'Correct! Artery / Aorta correctly identified.'
    },
    {
      id: 2,
      qNum: '2',
    ...
    },
    {
      ...
      total: 2,
      status: 'full',
      feedback: 'Detailed explanation covering Chlorophyll A & B, Light reactions (thylakoids) and Dark reactions (stroma).'
    },
    {
      id: 4,
      qNum: '4',
      ...
      total: 2,
      status: 'zero',
      feedback: 'Incorrect sequence. Right ventricle and tricuspid/pulmonary valve references were missing in the submission.'
    },
    {
      id: 5,
      qNum: '5',
      ...
      total: 2,
      status: 'full',
      feedback: 'Diagram accurately rendered with clear O₂ and CO₂ gas diffusion arrows.'
    },
    {
      id: 6,
      qNum: '6',
      ...
      total: 5,
      status: 'partial',
      feedback: 'Digestion site marked. Pancreas labeling slightly offset.'
    },
    {
      id: 7,
      qNum: '7',
      ...
      total: 5,
      status: 'full',
      feedback: 'Flawless anatomical drawing of renal nephron and renal corpuscle.'
    },
    {
      id: 8,
      qNum: '8',
      ...
      total: 5,
      status: 'partial',
      feedback: 'Air space difference noted. Palisade cell arrangement missing.'
    },
    {
      id: 9,
      qNum: '9',
      ...
      total: 5,
      status: 'full',
      feedback: 'Stomatal water evaporation and temperature/wind speed factors correctly identified.'
    },
    {
      id: 10,
      qNum: '10',
      ...
      total: 5,
      status: 'partial',
      feedback: 'Lignified walls & continuous lumen features correctly identified.'
    },
    {
      id: 11,
      qNum: '11a',
      ...
      total: 2,
      status: 'full',
      feedback: 'Etiolation phenomenon identified correctly.'
    },
    {
      id: 12,
      qNum: '11b',
      ...
      total: 3,
      status: 'partial',
      feedback: 'Partial credit awarded for sunlight exposure recommendation.'
    },
    {
      id: 13,
      qNum: '12',
      ...
      total: 5,
      status: 'partial',
      feedback: 'Minute volume calculated accurately as 6.0 L/min.'
    },
    {
      id: 14,
      qNum: '13',
      ...
      total: 5,
      status: 'partial',
      feedback: 'Working steps verified: (0.5 - 0.15) * 12 = 4.2 L/min.'
    }
  ]);
        ...
        <div className="w-1/2 flex flex-col bg-gray-900 overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto p-4 flex justify-center bg-[#202023] custom-scrollbar">
            ...
            >
              ...
              {/* LIVE AI BOUNDING BOX OVERLAY FOR Q2 (Matching Screenshot 3) */}
